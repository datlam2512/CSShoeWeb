...
export default function ProductMarketPlace() {
  ...
  return (
    <>
      <div className="sort">
        <div className="sort-limit">
          <div className="sort-by">
            ...
            <select id="changeSortBy" className="sortby-select" onChange={handleBrandChange} value={selectedBrand}>
          ...
          <div className="sort-by limit-by">
            ...
            <select id="setLimit" className="sortby-select" onChange={e => handleLimitChange(parseInt(e.target.value))} value={limit}>
          ...
          <div className="sort-by">
            ...
            <select id="changeSortBy" className="sortby-select" onChange={e => setSortOption(e.target.value)}>
      ...
      <div className="row">
        {filteredProducts.slice((currentPage - 1) * limit, currentPage * limit).map(product => (
          <Product key={product.id} id={product.id} imgUrl={product.urlImg} name={product.name} price={product.price.toLocaleString() + " VNĐ"} />
        ))}
      </div>

      <div className="pagination">
        <Pagination size="default" defaultCurrent={1} total={filteredProducts.length} pageSize={limit} current={currentPage} onChange={handlePageChange} />
      </div>
    </>
  );
}
