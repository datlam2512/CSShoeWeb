                    ...
                    <div className='width-product-infor'>
                        ...
                        <form class="payment-form">
                            <div class="size-selector">
                                <label for="size" style={{ fontFamily: "Karla,sans-serif" }}>Size:</label><br />
                            ...
                            <div class="quantity-selector">
                                <label for="quantity" style={{ fontFamily: "Karla,sans-serif" }}>Quantity:</label>
                                <div class="quantity-control">
                                    ...
                                    >
                                        <InputNumber bordered="false" min={1} max={99} defaultValue={1} />
                                    </ConfigProvider>
                                </div>
                            </div>
