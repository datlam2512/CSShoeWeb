...
const AdminEditProduct = () => {
  ...
  const param = useParams();
>>>>>>> parent of 1fb10b7 (update admin dashboard)
  ...
  const getUrlImg = async () => {
    ...
    try {
      const res = await axios.post(
        "https://api.imgbb.com/1/upload?key=a83bb7b270c95fd8a078837a2d919593",
        formData,
        {
          headers: {
          ...
          <div className="product-image">
            <div>
              <div>
                ...
                <div className="mt-3">
                  <img
                    src={file ? URL.createObjectURL(file) : urlImg}
                    alt="Selected"
                    style={{ maxWidth: "100%" }}
                  />
                </div>
          ...
          <div className="product-infor">
            <div className="width-product-infor">
              <div className="productSingle">
                ...
                <br />
                <input
                  className="productName mb-3"
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  type="text"
                  placeholder="Tên sản phẩm"
                />
                <label style={{ fontFamily: "Karla, sans-serif" }}>Giá:</label>
                <br />
                <input
                  value={price}
              ...
              <div className="purchase-action">
                <div className="addCartBtn">
                  {loading ? (
                    <button
                      disabled
                      className="rounded px-4 py-2 bg-blue-300 opacity-50"
                    >
                      Save
                    </button>
                  ) : (
                    <button
                      ...
                      className="rounded px-4 py-2 bg-blue-500"
                    >
                      Save
                    </button>
                  )}
